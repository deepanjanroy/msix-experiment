...
Write-Host "Compiling C++ application..." -ForegroundColor Green
# Compile the C++ application
& clang++ -std=c++17 -g .\main.cpp -o "$PackageDir\hello-msix.exe" -lShell32 -ladvapi32
